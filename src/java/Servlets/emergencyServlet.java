...
public class emergencyServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            String emergencyType = request.getParameter("emergency");
            
            emergencyForm_entities emf = new emergencyForm_entities(phoneNumber,adhaarNumber,emergencyType);
            
            User_Dao dao = new User_Dao(dbms_Connection.getConnection());
  
            if (dao.emergencyUser(emf)) {
                //save...
                out.println("done");
            } else {
                out.println("Error!!");
